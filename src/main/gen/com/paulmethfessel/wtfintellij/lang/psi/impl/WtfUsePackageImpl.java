...
public class WtfUsePackageImpl extends ASTWrapperPsiElement implements WtfUsePackage {

  public WtfUsePackageImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WtfVisitor visitor) {
    visitor.visitUsePackage(this);
  }
