...
public class WtfUseNamespaceImpl extends ASTWrapperPsiElement implements WtfUseNamespace {

  public WtfUseNamespaceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WtfVisitor visitor) {
    visitor.visitUseNamespace(this);
  }
