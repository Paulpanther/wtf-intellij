...
public class WtfCallStmtImpl extends WtfStmtImpl implements WtfCallStmt {

  public WtfCallStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public WtfCallExpr getCallExpr() {
    return findNotNullChildByClass(WtfCallExpr.class);
  }
