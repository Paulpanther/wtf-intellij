...
public class WtfReferenceExprImpl extends WtfExprImpl implements WtfReferenceExpr {

  public WtfReferenceExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public WtfVariable getVariable() {
    return findChildByClass(WtfVariable.class);
  }
