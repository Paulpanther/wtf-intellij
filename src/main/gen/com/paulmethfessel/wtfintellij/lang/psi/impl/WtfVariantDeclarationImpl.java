...
public class WtfVariantDeclarationImpl extends ASTWrapperPsiElement implements WtfVariantDeclaration {

  public WtfVariantDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WtfVisitor visitor) {
    visitor.visitVariantDeclaration(this);
  }
  ...
  @Override
  @NotNull
  public WtfVariantName getVariantName() {
    return findNotNullChildByClass(WtfVariantName.class);
  }

  @Override
  @NotNull
  public List<WtfVariantValue> getVariantValueList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, WtfVariantValue.class);
  }
