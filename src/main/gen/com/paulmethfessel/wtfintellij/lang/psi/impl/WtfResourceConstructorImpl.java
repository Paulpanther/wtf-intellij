...
public class WtfResourceConstructorImpl extends ASTWrapperPsiElement implements WtfResourceConstructor {

  public WtfResourceConstructorImpl(@NotNull ASTNode node) {
    super(node);
  }
