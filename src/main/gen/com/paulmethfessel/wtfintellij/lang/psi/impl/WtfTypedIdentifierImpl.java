...
public class WtfTypedIdentifierImpl extends ASTWrapperPsiElement implements WtfTypedIdentifier {

  public WtfTypedIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public WtfTypeIdentifier getTypeIdentifier() {
    return findNotNullChildByClass(WtfTypeIdentifier.class);
  }
