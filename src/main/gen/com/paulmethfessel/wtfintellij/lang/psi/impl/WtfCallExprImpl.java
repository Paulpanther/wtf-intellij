...
public class WtfCallExprImpl extends WtfExprImpl implements WtfCallExpr {

  public WtfCallExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public WtfFunctionCallName getFunctionCallName() {
    return findNotNullChildByClass(WtfFunctionCallName.class);
  }
