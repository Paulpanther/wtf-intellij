...
public class WtfFuncBodyImpl extends ASTWrapperPsiElement implements WtfFuncBody {

  public WtfFuncBodyImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<WtfStmt> getStmtList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, WtfStmt.class);
  }
