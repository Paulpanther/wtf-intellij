...
public class WtfConstructorArgumentImpl extends ASTWrapperPsiElement implements WtfConstructorArgument {

  public WtfConstructorArgumentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WtfVisitor visitor) {
    visitor.visitConstructorArgument(this);
  }
  ...
  @Override
  @NotNull
  public WtfConstructorArgumentName getConstructorArgumentName() {
    return findNotNullChildByClass(WtfConstructorArgumentName.class);
  }
