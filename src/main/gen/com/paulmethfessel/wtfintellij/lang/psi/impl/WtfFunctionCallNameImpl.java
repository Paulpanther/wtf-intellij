...
public class WtfFunctionCallNameImpl extends ASTWrapperPsiElement implements WtfFunctionCallName {

  public WtfFunctionCallNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WtfVisitor visitor) {
    visitor.visitFunctionCallName(this);
  }
