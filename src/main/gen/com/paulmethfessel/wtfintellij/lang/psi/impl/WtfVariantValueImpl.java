...
public class WtfVariantValueImpl extends ASTWrapperPsiElement implements WtfVariantValue {

  public WtfVariantValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WtfVisitor visitor) {
    visitor.visitVariantValue(this);
  }
  ...
  @Override
  @NotNull
  public List<WtfTypedIdentifier> getTypedIdentifierList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, WtfTypedIdentifier.class);
  }
