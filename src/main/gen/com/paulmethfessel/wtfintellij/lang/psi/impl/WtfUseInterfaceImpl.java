...
public class WtfUseInterfaceImpl extends ASTWrapperPsiElement implements WtfUseInterface {

  public WtfUseInterfaceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WtfVisitor visitor) {
    visitor.visitUseInterface(this);
  }
