...
public class WtfResourceFieldImpl extends ASTWrapperPsiElement implements WtfResourceField {

  public WtfResourceFieldImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WtfVisitor visitor) {
    visitor.visitResourceField(this);
  }
  ...
  @Override
  @NotNull
  public WtfTypedIdentifier getTypedIdentifier() {
    return findNotNullChildByClass(WtfTypedIdentifier.class);
  }
